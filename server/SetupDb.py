...
c.execute('CREATE TABLE {table_name_1} (\
    {user_name} {user_name_field} PRIMARY KEY NOT NULL,\
    {user_password} {user_password_field})'.format(table_name_1=table_name1,\
         user_name="user_name", user_name_field="BLOB", user_password="password", user_password_field="BLOB"))
...
c.execute('CREATE TABLE {table_name_2} (\
    ...
    PRIMARY KEY ({user_id_1}, {user_id_2}))'.format(table_name_2=table_name2,\
         user_id_1="user_id_1", user_id_field_1="INTEGER", user_table=table_name1, user_table_field="user_name",\
         user_id_2="user_id_2", user_id_field_2="INTEGER", chats="chat_field", chat_field="BLOB"))
